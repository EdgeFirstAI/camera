<!-- 
Thank you for contributing to EdgeFirst Camera!
...
# Expected: Camera streams successfully at 30 FPS
# Actual: ...
```
...
- [ ] Code quality meets project standards (see [AGENTS.md](../AGENTS.md))
